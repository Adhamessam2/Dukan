...
void main() {
  ...
  test(
    'loadProductDetails with initialProduct emits success immediately then updates',
    () async {
  ...
  test(
    'loadProductDetails with out of stock initialProduct sets quantity to 0',
    () async {
  ...
  test(
    'loadProductDetails without initialProduct emits loading then success',
    () async {
      mockRepository.productResult = const Right(tProduct);
  ...
  test(
    'loadProductDetails failure without initialProduct emits failure state',
    () async {
  ...
  test(
    'loadProductDetails failure with initialProduct emits errorMessage but keeps product and success status',
    () async {
      mockRepository.productResult = const Left(
        ServerFailure(message: 'Network error', code: 500),
      );
