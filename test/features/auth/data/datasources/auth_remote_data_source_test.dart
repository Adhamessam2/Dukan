...
class MockApiConsumer implements ApiConsumer {
  ...
  @override
  Future delete(String path, {Map<String, dynamic>? queryParameters, Map<String, String>? headers}) => throw UnimplementedError();
  @override
  Future get(String path, {Map<String, dynamic>? queryParameters, Map<String, String>? headers}) => throw UnimplementedError();
  @override
  Future patch(String path, {Map<String, dynamic>? body, Map<String, dynamic>? queryParameters, Map<String, String>? headers}) => throw UnimplementedError();
  @override
  Future put(String path, {Map<String, dynamic>? body, Map<String, dynamic>? queryParameters, Map<String, String>? headers}) => throw UnimplementedError();
}

void main() {
  test('signUp calls ApiConsumer.post with ServerStrings.register and returns SignUpResponseModel', () async {
  ...
  test('login calls ApiConsumer.post with ServerStrings.login and returns LoginResponseModel', () async {
    final mockApiConsumer = MockApiConsumer();
    final dataSource = AuthRemoteDataSourceImpl(apiConsumer: mockApiConsumer);
