...
void main() {
  testWidgets(
    'showSnackBar, showErrorSnackBar, showSuccessSnackBar display floating snackbars without assertion error',
    (tester) async {
              ...
              body: Builder(
                builder: (context) => Column(
                  children: [
                    ElevatedButton(
                      onPressed: () =>
                          context.showSnackBar('Test Normal SnackBar'),
                      child: const Text('Show Normal'),
                    ),
                    ElevatedButton(
                      onPressed: () =>
                          context.showErrorSnackBar('Test Error SnackBar'),
                      child: const Text('Show Error'),
                    ),
                    ElevatedButton(
                      onPressed: () =>
                          context.showSuccessSnackBar('Test Success SnackBar'),
